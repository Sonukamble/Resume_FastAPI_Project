...
from resume_filter_API.Configuration import temporary_file_path
from resume_filter_API.operation.CRUD import verify_password_reset_token_and_get_email, save_file_in_db, \
    get_file_details_from_user_id, delete_file_using_file_id
from resume_filter_API.operation.FileProcessOperation import pdf_to_text

file_router = APIRouter()

file_router.mount("/files", StaticFiles(directory="C:/Users/ADMIN/Documents/Workarea/ml_project_resume/temporary_path"),
                  name="files")
...
async def create_upload_file(
    ...
    try:
        ...
        if verify_user_response:
            ...
            file_location = f"{temporary_file_path}\\{file.filename}"
